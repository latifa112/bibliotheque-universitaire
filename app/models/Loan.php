...
class Loan extends Model {
    ...
    public function getUserLoans($userId) {
        $stmt = $this->db->prepare("SELECT l.*, b.title, b.author, b.cover_image FROM loans l JOIN books b ON l.book_id = b.id WHERE l.user_id = :user_id ORDER BY l.loan_date DESC");
...
public function getAllLoans() {
    ...
    error_log("getAllLoans returned " . count($result) . " records");
    return $result;
}
